...
export class Shop {
  ...
  // ── TICA 独立 Chance 赔率（null 时 fallback 到 rate_chance_*；与 NACIONAL 解耦） ──
  @Column({ name: 'tica_chance_1', type: 'decimal', precision: 10, scale: 2, nullable: true })
  tica_chance_1: number | null;

  @Column({ name: 'tica_chance_2', type: 'decimal', precision: 10, scale: 2, nullable: true })
  tica_chance_2: number | null;

  @Column({ name: 'tica_chance_3', type: 'decimal', precision: 10, scale: 2, nullable: true })
  tica_chance_3: number | null;

  // ── NICA 独立赔率（NICA chain/chance null 时 fallback 到 TICA chain_*/rate_chance_*） ──
